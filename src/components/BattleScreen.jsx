...
const AREA_DECORATIONS = {
  forest: [
    { type: 'tree', x: 8, y: 18, size: 36 },
    { type: 'tree', x: 25, y: 12, size: 28 },
    { type: 'tree', x: 72, y: 16, size: 34 },
    { type: 'tree', x: 90, y: 24, size: 30 },
    { type: 'tree', x: 55, y: 68, size: 32 },
    { type: 'tree', x: 82, y: 72, size: 26 },
    { type: 'bush', x: 40, y: 78, size: 18 },
    { type: 'bush', x: 62, y: 82, size: 16 },
    { type: 'bush', x: 18, y: 65, size: 14 },
    { type: 'rock', x: 48, y: 14, size: 16 },
    { type: 'rock', x: 12, y: 45, size: 12 },
    { type: 'rock', x: 88, y: 52, size: 14 },
  ],
  cave: [
    { type: 'rock', x: 6, y: 20, size: 34 },
    { type: 'rock', x: 30, y: 14, size: 26 },
    { type: 'rock', x: 82, y: 18, size: 38 },
    { type: 'rock', x: 92, y: 46, size: 22 },
    { type: 'rock', x: 74, y: 76, size: 28 },
    { type: 'rock', x: 20, y: 74, size: 24 },
    { type: 'crystal', x: 45, y: 22, size: 22 },
    { type: 'crystal', x: 58, y: 66, size: 20 },
    { type: 'crystal', x: 18, y: 52, size: 16 },
    { type: 'stalagmite', x: 36, y: 82, size: 24 },
    { type: 'stalagmite', x: 64, y: 84, size: 22 },
    { type: 'stalagmite', x: 88, y: 66, size: 18 },
  ],
  castle: [
    { type: 'pillar', x: 12, y: 18, size: 28 },
    { type: 'pillar', x: 28, y: 16, size: 24 },
    { type: 'pillar', x: 72, y: 16, size: 24 },
    { type: 'pillar', x: 86, y: 18, size: 28 },
    { type: 'torch', x: 8, y: 42, size: 18 },
    { type: 'torch', x: 24, y: 44, size: 16 },
    { type: 'torch', x: 74, y: 44, size: 16 },
    { type: 'torch', x: 90, y: 42, size: 18 },
    { type: 'shield', x: 22, y: 76, size: 20 },
    { type: 'shield', x: 40, y: 80, size: 18 },
    { type: 'shield', x: 60, y: 80, size: 18 },
    { type: 'shield', x: 78, y: 76, size: 20 },
  ],
  shadow: [
    { type: 'void', x: 15, y: 18, size: 38 },
    { type: 'void', x: 42, y: 22, size: 30 },
    { type: 'void', x: 70, y: 24, size: 34 },
    { type: 'void', x: 88, y: 48, size: 26 },
    { type: 'void', x: 25, y: 72, size: 32 },
    { type: 'void', x: 60, y: 76, size: 28 },
    { type: 'crack', x: 8, y: 58, size: 26 },
    { type: 'crack', x: 36, y: 86, size: 24 },
    { type: 'crack', x: 74, y: 52, size: 22 },
    { type: 'crack', x: 86, y: 78, size: 26 },
  ],
}
