...
const AREA_DECORATIONS = {
  forest: [
    { type: 'tree', x: 8, y: 18, size: 50 },
    { type: 'tree', x: 18, y: 10, size: 42 },
    { type: 'tree', x: 14, y: 34, size: 34 },
    { type: 'tree', x: 74, y: 16, size: 48 },
    { type: 'tree', x: 86, y: 28, size: 44 },
    { type: 'bush', x: 32, y: 78, size: 26 },
    { type: 'bush', x: 48, y: 84, size: 24 },
    { type: 'bush', x: 64, y: 76, size: 22 },
    { type: 'rock', x: 52, y: 14, size: 22 },
    { type: 'rock', x: 40, y: 22, size: 18 },
  ],
  cave: [
    { type: 'rock', x: 8, y: 22, size: 52 },
    { type: 'rock', x: 18, y: 12, size: 42 },
    { type: 'rock', x: 12, y: 40, size: 34 },
    { type: 'rock', x: 82, y: 20, size: 56 },
    { type: 'rock', x: 90, y: 36, size: 36 },
    { type: 'crystal', x: 38, y: 70, size: 30 },
    { type: 'crystal', x: 58, y: 74, size: 26 },
    { type: 'stalagmite', x: 26, y: 80, size: 34 },
    { type: 'stalagmite', x: 70, y: 82, size: 32 },
  ],
  castle: [
    { type: 'pillar', x: 10, y: 18, size: 42 },
    { type: 'pillar', x: 24, y: 18, size: 36 },
    { type: 'pillar', x: 76, y: 18, size: 36 },
    { type: 'pillar', x: 90, y: 18, size: 42 },
    { type: 'torch', x: 16, y: 46, size: 26 },
    { type: 'torch', x: 84, y: 46, size: 26 },
    { type: 'shield', x: 30, y: 78, size: 28 },
    { type: 'shield', x: 50, y: 84, size: 26 },
    { type: 'shield', x: 70, y: 78, size: 28 },
  ],
  shadow: [
    { type: 'void', x: 16, y: 20, size: 58 },
    { type: 'void', x: 30, y: 30, size: 40 },
    { type: 'void', x: 74, y: 22, size: 52 },
    { type: 'void', x: 88, y: 38, size: 40 },
    { type: 'crack', x: 22, y: 74, size: 36 },
    { type: 'crack', x: 46, y: 84, size: 32 },
    { type: 'crack', x: 78, y: 72, size: 36 },
  ],
}
