...
const AREA_DECORATIONS = {
  forest: [
    ...
    { type: 'tree', x: 18, y: 12, size: 28 },
    { type: 'tree', x: 14, y: 32, size: 22 },
    { type: 'tree', x: 74, y: 16, size: 34 },
    { type: 'tree', x: 86, y: 26, size: 30 },
    { type: 'bush', x: 32, y: 78, size: 18 },
    { type: 'bush', x: 48, y: 82, size: 16 },
    { type: 'bush', x: 62, y: 76, size: 14 },
    { type: 'rock', x: 52, y: 14, size: 16 },
    { type: 'rock', x: 40, y: 20, size: 12 },
  ],
  cave: [
    { type: 'rock', x: 8, y: 22, size: 34 },
    { type: 'rock', x: 18, y: 14, size: 26 },
    { type: 'rock', x: 12, y: 38, size: 22 },
    { type: 'rock', x: 82, y: 20, size: 38 },
    { type: 'rock', x: 88, y: 34, size: 24 },
    { type: 'crystal', x: 38, y: 70, size: 20 },
    { type: 'crystal', x: 56, y: 74, size: 18 },
    { type: 'stalagmite', x: 26, y: 80, size: 24 },
    { type: 'stalagmite', x: 68, y: 82, size: 22 },
  ],
  castle: [
    { type: 'pillar', x: 10, y: 18, size: 28 },
    { type: 'pillar', x: 24, y: 18, size: 24 },
    { type: 'pillar', x: 76, y: 18, size: 24 },
    { type: 'pillar', x: 90, y: 18, size: 28 },
    { type: 'torch', x: 16, y: 46, size: 18 },
    { type: 'torch', x: 84, y: 46, size: 18 },
    { type: 'shield', x: 30, y: 78, size: 20 },
    { type: 'shield', x: 50, y: 82, size: 18 },
    { type: 'shield', x: 70, y: 78, size: 20 },
  ],
  shadow: [
    { type: 'void', x: 16, y: 20, size: 38 },
    { type: 'void', x: 30, y: 28, size: 26 },
    { type: 'void', x: 74, y: 22, size: 34 },
    { type: 'void', x: 88, y: 36, size: 26 },
    { type: 'crack', x: 22, y: 74, size: 26 },
    { type: 'crack', x: 46, y: 82, size: 24 },
    { type: 'crack', x: 78, y: 72, size: 26 },
  ],
}
