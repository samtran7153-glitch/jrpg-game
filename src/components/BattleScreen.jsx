...
const AREA_DECORATIONS = {
  forest: [
    { type: 'tree', x: 8, y: 18, size: 64 },
    { type: 'tree', x: 22, y: 10, size: 56 },
    { type: 'tree', x: 85, y: 22, size: 62 },
    { type: 'tree', x: 72, y: 12, size: 54 },
    { type: 'tree', x: 65, y: 72, size: 64 },
    { type: 'tree', x: 90, y: 68, size: 56 },
    { type: 'tree', x: 5, y: 55, size: 50 },
    { type: 'bush', x: 35, y: 78, size: 40 },
    { type: 'bush', x: 55, y: 82, size: 36 },
    { type: 'bush', x: 92, y: 48, size: 40 },
    { type: 'bush', x: 18, y: 42, size: 32 },
    { type: 'bush', x: 48, y: 8, size: 36 },
    { type: 'rock', x: 42, y: 15, size: 36 },
    { type: 'rock', x: 78, y: 42, size: 34 },
  ],
  cave: [
    { type: 'rock', x: 8, y: 20, size: 66 },
    { type: 'rock', x: 25, y: 10, size: 58 },
    { type: 'rock', x: 88, y: 18, size: 68 },
    { type: 'rock', x: 74, y: 8, size: 56 },
    { type: 'rock', x: 78, y: 78, size: 64 },
    { type: 'rock', x: 92, y: 62, size: 52 },
    { type: 'rock', x: 5, y: 58, size: 50 },
    { type: 'crystal', x: 30, y: 74, size: 48 },
    { type: 'crystal', x: 58, y: 22, size: 46 },
    { type: 'crystal', x: 18, y: 36, size: 42 },
    { type: 'crystal', x: 70, y: 48, size: 36 },
    { type: 'stalagmite', x: 42, y: 82, size: 58 },
    { type: 'stalagmite', x: 12, y: 78, size: 52 },
    { type: 'stalagmite', x: 62, y: 65, size: 46 },
  ],
  castle: [
    { type: 'pillar', x: 12, y: 18, size: 64 },
    { type: 'pillar', x: 28, y: 12, size: 56 },
    { type: 'pillar', x: 72, y: 12, size: 56 },
    { type: 'pillar', x: 86, y: 18, size: 64 },
    { type: 'torch', x: 8, y: 42, size: 46 },
    { type: 'torch', x: 22, y: 52, size: 44 },
    { type: 'torch', x: 78, y: 52, size: 44 },
    { type: 'torch', x: 92, y: 42, size: 46 },
    { type: 'shield', x: 35, y: 80, size: 48 },
    { type: 'shield', x: 50, y: 85, size: 46 },
    { type: 'shield', x: 65, y: 78, size: 48 },
    { type: 'shield', x: 18, y: 68, size: 40 },
    { type: 'shield', x: 82, y: 68, size: 40 },
  ],
  shadow: [
    { type: 'void', x: 15, y: 18, size: 74 },
    { type: 'void', x: 42, y: 10, size: 60 },
    { type: 'void', x: 75, y: 22, size: 68 },
    { type: 'void', x: 88, y: 48, size: 58 },
    { type: 'void', x: 45, y: 78, size: 76 },
    { type: 'void', x: 10, y: 68, size: 52 },
    { type: 'crack', x: 12, y: 58, size: 58 },
    { type: 'crack', x: 32, y: 42, size: 52 },
    { type: 'crack', x: 58, y: 55, size: 54 },
    { type: 'crack', x: 82, y: 72, size: 58 },
    { type: 'crack', x: 65, y: 35, size: 46 },
  ],
}
