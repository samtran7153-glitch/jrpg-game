...
const AREA_DECORATIONS = {
  forest: [
    { type: 'tree', x: 12, y: 20, size: 28 },
    { type: 'tree', x: 82, y: 25, size: 26 },
    { type: 'tree', x: 70, y: 70, size: 30 },
    { type: 'bush', x: 28, y: 75, size: 20 },
    { type: 'bush', x: 88, y: 55, size: 18 },
    { type: 'rock', x: 45, y: 15, size: 18 },
  ],
  cave: [
    { type: 'rock', x: 10, y: 22, size: 30 },
    { type: 'rock', x: 85, y: 18, size: 34 },
    { type: 'rock', x: 75, y: 75, size: 28 },
    { type: 'crystal', x: 25, y: 70, size: 24 },
    { type: 'crystal', x: 60, y: 25, size: 22 },
    { type: 'stalagmite', x: 40, y: 80, size: 28 },
  ],
  castle: [
    { type: 'pillar', x: 18, y: 20, size: 28 },
    { type: 'pillar', x: 80, y: 20, size: 28 },
    { type: 'torch', x: 12, y: 45, size: 22 },
    { type: 'torch', x: 86, y: 45, size: 22 },
    { type: 'shield', x: 30, y: 78, size: 24 },
    { type: 'shield', x: 68, y: 76, size: 24 },
  ],
  shadow: [
    { type: 'void', x: 20, y: 20, size: 34 },
    { type: 'void', x: 70, y: 25, size: 30 },
    { type: 'void', x: 45, y: 75, size: 36 },
    { type: 'crack', x: 15, y: 60, size: 28 },
    { type: 'crack', x: 80, y: 70, size: 26 },
  ],
}
