...
const AREA_DECORATIONS = {
  forest: [
    { type: 'tree', x: 8, y: 18, size: 75 },
    { type: 'tree', x: 18, y: 8, size: 64 },
    { type: 'tree', x: 14, y: 36, size: 54 },
    { type: 'tree', x: 60, y: 12, size: 58 },
    { type: 'tree', x: 74, y: 16, size: 72 },
    { type: 'tree', x: 86, y: 30, size: 66 },
    { type: 'tree', x: 96, y: 18, size: 48 },
    { type: 'bush', x: 32, y: 78, size: 36 },
    { type: 'bush', x: 48, y: 86, size: 32 },
    { type: 'bush', x: 64, y: 76, size: 28 },
    { type: 'bush', x: 80, y: 74, size: 26 },
    { type: 'bush', x: 6, y: 66, size: 24 },
    { type: 'rock', x: 22, y: 68, size: 22 },
    { type: 'rock', x: 40, y: 24, size: 24 },
    { type: 'rock', x: 52, y: 14, size: 30 },
  ],
  cave: [
    { type: 'rock', x: 8, y: 22, size: 78 },
    { type: 'rock', x: 18, y: 10, size: 64 },
    { type: 'rock', x: 12, y: 42, size: 50 },
    { type: 'rock', x: 82, y: 20, size: 84 },
    { type: 'rock', x: 92, y: 38, size: 54 },
    { type: 'rock', x: 48, y: 12, size: 46 },
    { type: 'crystal', x: 38, y: 70, size: 44 },
    { type: 'crystal', x: 60, y: 74, size: 38 },
    { type: 'crystal', x: 16, y: 60, size: 30 },
    { type: 'stalagmite', x: 26, y: 80, size: 48 },
    { type: 'stalagmite', x: 72, y: 82, size: 44 },
    { type: 'stalagmite', x: 48, y: 86, size: 36 },
  ],
  castle: [
    { type: 'pillar', x: 10, y: 18, size: 62 },
    { type: 'pillar', x: 24, y: 18, size: 54 },
    { type: 'pillar', x: 76, y: 18, size: 54 },
    { type: 'pillar', x: 90, y: 18, size: 62 },
    { type: 'torch', x: 16, y: 46, size: 36 },
    { type: 'torch', x: 84, y: 46, size: 36 },
    { type: 'torch', x: 38, y: 44, size: 28 },
    { type: 'torch', x: 62, y: 44, size: 28 },
    { type: 'shield', x: 30, y: 78, size: 40 },
    { type: 'shield', x: 50, y: 86, size: 36 },
    { type: 'shield', x: 70, y: 78, size: 40 },
    { type: 'shield', x: 12, y: 76, size: 32 },
  ],
  shadow: [
    { type: 'void', x: 16, y: 20, size: 86 },
    { type: 'void', x: 30, y: 32, size: 60 },
    { type: 'void', x: 74, y: 22, size: 78 },
    { type: 'void', x: 88, y: 40, size: 60 },
    { type: 'void', x: 48, y: 20, size: 52 },
    { type: 'crack', x: 22, y: 74, size: 50 },
    { type: 'crack', x: 46, y: 86, size: 44 },
    { type: 'crack', x: 78, y: 72, size: 50 },
    { type: 'crack', x: 6, y: 50, size: 38 },
  ],
}
